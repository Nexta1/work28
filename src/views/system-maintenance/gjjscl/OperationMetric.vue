<template>
  <div class="operation-metric-container">
      ...
      this.$refs.form.validate(async valid => {
        ...
        try {
          ...
          if (this.formData.operationMetricId) {
            ...
            await apiAdd('operationMetric', submitData)
