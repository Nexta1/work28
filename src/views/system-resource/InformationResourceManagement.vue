      ...
      <el-popover
        ...
        <div class="relation-popover-body">
          ...
          <div class="relation-list">
            <div class="relation-item" :class="{active: activeTab === 'bshSegment'}">
              <span class="rel-num">①</span>
              <span class="rel-text">编识号段预分配 — 定义号段范围（战区·军种·类型·起止号）</span>
            </div>
            <div class="rel-arrow">↓</div>
            <div class="relation-item" :class="{active: activeTab === 'ptBshSegment'}">
              <span class="rel-num">②</span>
              <span class="rel-text">平台编识号分配 — 预分配号段分配到平台</span>
            </div>
            <div class="rel-arrow">↓</div>
            <div class="relation-item" :class="{active: activeTab === 'ptBshAllocate'}">
              <span class="rel-num">③</span>
              <span class="rel-text">编识号业务分配 — 平台号段分配给具体业务</span>
            </div>
          </div>
        </div>
      </el-popover>
...
export default {
  ...
  methods: {
    ...
    fetchPtBsh() {
      ...
      if (this.ptBshQuery.SSZQNM != null)
        params.SSZQNM = this.ptBshQuery.SSZQNM
      if (this.ptBshQuery.SSJZNM != null)
        params.SSJZNM = this.ptBshQuery.SSJZNM
